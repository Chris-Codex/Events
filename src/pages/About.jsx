            ...
            <section className="flex justify-center mt-20">
                <div className="w-full max-w-[320px] sm:w-full sm:max-w-[1075px] md:max-w-[750px] lg:max-w-[1075px] bg-[#06c168] pt-5 pb-12 rounded-[20px]">
                    <div className="flex flex-col justify-center items-center ">
                        <h2 className="text-[25px] text-[#fff] font-[500] sm:text-[60px]">Our Creative Journey</h2>
                        <p className="text-[17px] px-3 text-center text-[#fff] sm:text-[22px]">Empowering creatives through immersive experiences since 2018</p>
                    </div>
